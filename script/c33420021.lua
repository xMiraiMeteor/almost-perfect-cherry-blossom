...
function s.initial_effect(c)
	--Place 1 Butterfly Counter on all face-up opponent's monsters that does not have one
	...
	c:RegisterEffect(e1)
	--Add 1 Zombie monster from GY to hand
...
s.counter_place_list={0x1fed} --Butterfly Counter
