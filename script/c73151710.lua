...
function s.initial_effect(c)
	--Banish all opponent's monsters with a Butterfly Counter
...
s.counter_list={0x1fed} --Butterfly Counter
...
function s.filter(c)
	return c:IsFaceup() and c:IsAbleToRemove() and c:GetCounter(0x1fed)==1
end
